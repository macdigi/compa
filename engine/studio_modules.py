...
STUDIO_MODULES: tuple[StudioModule, ...] = (
    ...
    StudioModule(
        ...
        features=("16 pads", "one-shot playback", "sample assignment"),
        next_steps=("sample browser", "pad edit macros", "choke groups"),
    ...
    StudioModule(
        ...
        features=("16 generated voices", "808/909 kits", "voice macros"),
        next_steps=("pattern clips", "voice editor", "kit storage"),
    ...
    StudioModule(
        ...
        features=("bass/lead/pad tracks", "preset switching", "Push macros"),
        next_steps=("clip capture", "preset storage", "poly voice editor"),
    ...
    StudioModule(
        ...
        features=("track targets", "mute/solo/arm", "Push route view"),
        next_steps=("route matrix", "meter bridge", "network peer editor"),
    ...
    StudioModule(
        ...
        features=("capture deck", "clip recording", "SP record pass"),
        next_steps=("take browser actions", "resample bus", "SP pattern sync"),
